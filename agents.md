...
Tienes en ./.venv. las herramientas necesarias para ejecutar los tests y además puedes añadir las librerías y todo lo que necesites para la ejecución en ese .venv. Puedes modificarlo según tus necesidades.
